...
# Confusion Matrix
library(gmodels)
CrossTable(pokemon_test$Legendary, pokemon_predict$BinaryLogitPredict,prop.r=TRUE, prop.c=FALSE, prop.t=FALSE,
...
CrossTable(pokemon_forest_predict, pokemon_test, prob.r = FALSE, prob.c = FALSE, 
            prob.t = FALSE, prob.chisq = FALSE, dnn = c("Predicted", "Actual"))
